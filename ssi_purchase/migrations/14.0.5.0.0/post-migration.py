...
_POLICY_UPDATES = [
    (
        "purchase_order_policy_template_detail_restart_approval",
...
def migrate(cr, version):
    if not version:
        return
    _logger.info("Updating ssi_purchase policy template additional_python_code...")
    ...
    _logger.info("Done updating ssi_purchase policy template additional_python_code.")
